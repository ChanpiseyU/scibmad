...
Minimizing a Chebyshev Polynomial
...
optimizer2 = torch.optim.Adam([a2, b2, c2], lr=1e-3)
...
For more detailed tutorials and examples, see the [User Guide](https://github.com/ChanpiseyU/scibmad/blob/main/user_guide.md).
